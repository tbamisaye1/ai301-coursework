...
I write Python, JavaScript and React comfortably. I can also write C and C#, but both are much weaker than my other languages. I want to get better at building agentic AI systems and at machine learning, and I'm also happy to take web development and backend work. I'd like to avoid design tasks (visual or UI design, styling, graphics), because design isn't my strength.
